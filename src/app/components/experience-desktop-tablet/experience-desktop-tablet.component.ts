...
@Component({
  selector: 'app-experience-desktop-tablet',
  standalone: true,
  imports: [NgFor, NgIf, MatIconModule],
  templateUrl: './experience-desktop-tablet.component.html',
  styleUrl: './experience-desktop-tablet.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ExperienceDesktopTabletComponent {
