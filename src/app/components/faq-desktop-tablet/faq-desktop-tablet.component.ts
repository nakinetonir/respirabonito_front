...
@Component({
  selector: 'app-faq-desktop-tablet',
  standalone: true,
  imports: [NgFor, MatExpansionModule, MatIconModule],
  templateUrl: './faq-desktop-tablet.component.html',
  styleUrl: './faq-desktop-tablet.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FaqDesktopTabletComponent {
  readonly faqs = [
    ...
    { icon: 'sync_alt', q: '¿Qué ocurre si mi situación cambia y me impide seguir el ritmo propuesto?', a: 'Las propuestas son eso: propuestas. Podrás avanzar a tu ritmo, sin presión. En caso de duda, puedes comunicarnos tu caso y valoraremos juntas la mejor opción.' },
    ...
    { icon: 'tune', q: '¿Es un contenido fijo o tengo algún poder de decisión en lo que quiero aprender?', a: 'Habrá un contenido central, único para todos los alumnos, y contenidos optativos, temarios donde podrás elegir el que más te guste.' },
    ...
    { icon: 'help', q: '¿Me podrías ayudar a tomar la decisión?', a: '¡Claro! Rellena el formulario y nos pondremos en contacto contigo.' },
