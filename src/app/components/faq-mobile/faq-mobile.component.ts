...
export class FaqMobileComponent {
  readonly faqs = [
    ...
    { icon: 'tune', q: '¿Es un contenido fijo o tengo algún poder de decisión en lo que quiero aprender?', a: 'Habrá un contenido central para todas y contenidos optativos que podrás elegir a tu gusto.' },
