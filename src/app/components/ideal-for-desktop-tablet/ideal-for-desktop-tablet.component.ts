...
@Component({
  selector: 'app-ideal-for-desktop-tablet',
  standalone: true,
  imports: [NgFor, MatIconModule],
  templateUrl: './ideal-for-desktop-tablet.component.html',
  styleUrl: './ideal-for-desktop-tablet.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class IdealForDesktopTabletComponent {
  readonly pairs: readonly IdealForPair[] = [
    ...
    },
    {
      ...
      benefit: {
        ...
        before: '',
        emphasis: '',
        after: ' Fortalecimiento corporal y mental.'
      },
      feeling: {
        icon: 'favorite',
