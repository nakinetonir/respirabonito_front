...
@Component({
  selector: 'app-method-desktop-tablet',
  standalone: true,
  imports: [NgFor, MatCardModule, MatIconModule],
  templateUrl: './method-desktop-tablet.component.html',
  styleUrl: './method-desktop-tablet.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MethodDesktopTabletComponent implements AfterViewInit {
