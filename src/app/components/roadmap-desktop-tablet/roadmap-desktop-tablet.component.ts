...
@Component({
  selector: 'app-roadmap-desktop-tablet',
  standalone: true,
  encapsulation: ViewEncapsulation.None,
  imports: [NgFor, MatIconModule],
  templateUrl: './roadmap-desktop-tablet.component.html',
  styleUrl: './roadmap-desktop-tablet.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RoadmapDesktopTabletComponent implements AfterViewInit, OnDestroy {
